    ...
    runFetch() {
        fetch('https://api.parcelmonkey.co.uk/GetQuote', {
            ...
            .then((body) => {
                ...
                if (body) {
                    this.setState({ resultsArray: body }); { this.props.array(this.state.resultsArray) }
                }
            })
            .catch((error) => {
            ...
            <div className='form'>
                <form className='form__main'onSubmit={this.handleSubmit}>
                    <div className='form__main__selections'>
                        <a href='#'className='form__main__selections__parcelDelivery container'> Parcel Delivery </a> 
                        <a href='#'className='form__main__selections__parcelMonkeyLocal'><p>NEW&nbsp;</p><p>ParcelMonkey</p><p>Local</p></a> 
                    </div> 
                    ...
                    <div className="form__main__fromAndToCountry container" >
                        ...
                        <div className="form__main__fromAndToCountry__countryTo">
                            <InputCountry receiveText={this.countryTo} labelName='Delivering to' />
                            <InputForm 
                                nameClass={this.state.displayOffOn}
                    ...
                    <button className='form__main__button container'>Get Quote & Book</button> 
                    <span className="form__main__longerThan1Meter container"onClick={this.handleClick}> 
